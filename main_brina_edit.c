...
void noFinalNeutro();
 ...
 // Função que mostrar os desenhos na tela
...
void noDaIara3C() {
    ...
    noDaIara4B(); break;
    case 3:
    printf("Ele usa o remo como um leme, girando o barco lentamente, tentando encontrar de onde vem a voz. Mas a voz parece acompanhá-lo. É então que ele percebe a sombra enorme sob o casco, girando junto com ele, como um guardião paciente esperando sua decisão.\n");
    noDaIara4C(); break;
    }
}
...
void noDaMatinta1B() {
	...
	printf("|                                   um assobio agudo, que parecia cortar o vento...                                    |\n");
	...
	case 1:
	printaLinha();
	printf("|  Movido pela teimosia, Bento decide confrontar o som. Ele se levanta, sentindo a madeira fria do chão sob os pés,    |\n");
	printf("|                e caminha decidido até a janela, pronto para encarar o que quer que estivesse lá fora.                |\n");
	printaLinha(); noDaMatinta2A(); break;

	case 2: 
	printaLinha();
	printf("|   O medo foi mais forte. Bento se encolheu, puxando o lençol sobre a cabeça, tentando transformar o próprio corpo    |\n");
	printf("|            em uma estátua. Ele esperava que, com o silêncio, o assobio simplesmente fosse embora.                    |\n");
	printaLinha(); noDaMatinta2B(); break;

	case 3:
	printaLinha();
	printf("|    Lembrando-se das histórias dos antigos, Bento escolheu o caminho da prudência. Sem fazer barulho, ele procurou    |\n");
	printf("|      seu fumo de rolo, entendendo que aquela não era uma visita comum, e sim um pedido que era melhor atender.       |\n");
	printaLinha(); noDaMatinta2C(); break;
	}	
...
void noDaMatinta2A() {
	...
	printaLinha();
	printf("|   Cheio de coragem ou de teimosia, Bento se levantou e foi até a janela de madeira. Com um empurrão, ele a abriu.    |\n");
	printf("|  O ar frio da noite entrou de vez, e junto com ele, o silêncio. O assobio parou. Mas bem ali, parada sob o sereno,   |\n");
	printf("|  estava uma velha muito encurvada, com o rosto todo enrugado e olhos que pareciam duas brasas acesas na escuridão,   |\n");
	printf("|                                            encarando-o fixamente.                                                    |\n");
	...
	case 1:
	printaLinha();
	printf("|   Engolindo em seco, Bento decide usar a educação. Com a voz um pouco trêmula, ele se inclina para fora e quebra     |\n");
	printf("|                       o silêncio, dirigindo-se diretamente à figura misteriosa.                                      |\n");
	printaLinha(); noDaMatinta3A(); break;

	case 2:
	printaLinha();
	printf("|  O pânico tomou conta. Num movimento brusco e impensado, Bento bateu a janela com toda a força, o som da madeira     |\n");
	printf("|             ecoando na noite. Ele achou que o barulho resolveria o problema, mas só piorou.                          |\n");
	printaLinha(); noDaMatinta3B(); break;

	case 3:
	printaLinha();
	printf("|      Irritado, Bento agiu sem pensar. Ele pegou o copo d'água que estava ao lado da rede e o arremessou na           |\n");
	printf("|      direção da velha. A água se espalhou no ar, mas antes que a atingisse, algo muito estranho aconteceu.           |\n");
	printaLinha(); noDaMatinta3C(); break;
	}
}
...
void noDaMatinta2B() {
	...
	printaLinha();
	printf("|Bento se encolheu na rede, cobrindo a cabeça com o lençol, o coração batendo forte. Ele decidiu ignorar. Mas o assobio|\n");
	printf("|    não foi embora. Pelo contrário, parecia que ele atravessava a madeira da parede, ficando cada vez mais perto,     |\n");
	printf("|      mais insistente, bem ao lado do seu ouvido, como se a criatura estivesse ali, dentro do quarto com ele.         |\n");
	...
	case 1:
	printaLinha();
	printf("|  A curiosidade foi mais forte que o medo. Com o coração na boca, ele afastou um pouco o lençol e procurou uma fresta |\n");
	printf("|          na madeira da parede, apenas um pequeno buraco para ver o que estava acontecendo lá fora.                   |\n");
	printaLinha(); noDaMatinta3C(); break;

	case 2:
	printaLinha();
	printf("|  Bento fechou os olhos com força e começou a sussurrar uma prece antiga que sua avó lhe ensinou. Ele se apegou às    |\n");
	printf("|       palavras sagradas, esperando que elas pudessem criar um escudo contra o mal que estava lá fora.                |\n");
	printaLinha(); noDaMatinta3A(); break;

	case 3:
	printaLinha();
	printf("|De repente, a paciência de Bento acabou. De debaixo do lençol, ele encheu os pulmões e gritou com toda a sua força,   |\n");
	printf("|                      uma ordem carregada de pavor e raiva, na esperança de expulsar a criatura.                      |\n");
	printaLinha(); noDaMatinta3B(); break;
	}
...
void noDaMatinta2C() {
	...
	printaLinha();
	printf("|        Bento, lembrando das histórias de sua avó, decidiu não arriscar. Ele se levantou em silêncio,                 |\n");
	printf("|          pegou um punhado do seu melhor fumo de rolo e foi até a porta. Ele abriu só uma frestinha                   |\n");
	printf("|       o suficiente para colocar o fumo em cima de uma pedra ao lado da soleira, e fechou a porta devagar,            |\n");
	printf("|                     sem fazer barulho. O assobio parou no mesmo instante.                                            |\n");
	...
	case 1:
	printaLinha();
	printf("|   Feito o gesto de paz, a curiosidade falou mais alto. Ele correu para a janela, se escondendo atrás da cortina,     |\n");
	printf("|                  para ver quem ou o quê viria buscar a oferenda que ele deixou.                                      |\n");

	printaLinha(); noDaMatinta3C(); break;

	case 2:
	printaLinha();
	printf("|           Confiando que tinha feito a coisa certa, Bento decidiu não se envolver mais. Ele voltou para sua rede,     |\n");
	printf("|                deitou-se e tentou acalmar o coração, esperando que a noite finalmente lhe trouxesse paz.             |\n");
	printaLinha(); noDaMatinta3A(); break;

	case 3:
	printaLinha();
	printf("|  A impaciência o dominou. Querendo ter certeza de que o perigo tinha passado, ele levou a mão à maçaneta novamente,  |\n");
	printf("|                  cometendo a imprudência de quebrar o ritual e perturbar o silêncio.                                 |\n");
	printaLinha(); noDaMatinta3B(); break;
	}
...
void noDaMatinta3A() {
	...
	printaLinha();
	printf("|               No silêncio que se formou, uma voz rouca e baixa, que parecia o raspar de folhas secas,                |\n");
	printf("|                 atravessou a noite e chegou até Bento. 'Fumo... um trago de fumo...', a voz pedia.                   |\n");
	printf("|         Não era um grito, era um lamento, um pedido que parecia carregar o cansaço de muitos e muitos anos.          |\n");
	printaLinha();
	...
	case 1:
	printaLinha();
	printf("|      Com as mãos trêmulas, Bento pega o fumo e o oferece. A mão enrugada da velha surge da escuridão e pega a        |\n");
	printf("|                  oferenda com uma rapidez surpreendente, antes de recuar para as sombras.                            |\n");
	printaLinha(); noDaMatinta4A(); break;

	case 2:
	printaLinha();
	printf("|             Mentindo por medo, Bento grita para a noite que não tem fumo ali. A voz dele soa fraca,                  |\n");
	printf("|       e a resposta que vem não é em palavras, mas em um assobio que recomeça, mais alto e irritado do que antes.     |\n");
	printaLinha(); noDaMatinta4B(); break;

	case 3:
	printaLinha();
	printf("|                    Bento fica paralisado, incapaz de falar. O silêncio se estica, pesado e tenso.                    |\n");
	printf("|    A velha do lado de fora parece interpretar a quietude como uma recusa, e ele sente a presença dela se movendo,    |\n");
	printf("|           Bento fica paralisado, incapaz de falar. O silêncio se estica, pesado e tenso.  circulando a casa.         |\n");
	printaLinha(); noDaMatinta4C(); break;
	}
...
void noDaMatinta3B() {
	...
	printaLinha();
	printf("|  A atitude de Bento foi como uma ofensa. No momento em que ele terminou, um vento forte e repentino sacudiu a casa.  |\n");
	printf("|                      As telhas tremeram, as portas bateram e o assobio, que antes era fino,                          |\n");
	printf("|                se transformou em uma gargalhada terrível e aguda que parecia vir de cima, do telhado,                |\n");
	printf("|             aguda que parecia vir de cima, do telhado, como se um pássaro gigante estivesse pousado ali.             |\n");
	...
	case 1:
	printaLinha();
	printf("|        O barulho no telhado é aterrorizante. Bento se joga no chão e desliza para debaixo da rede,                   |\n");
	printf("|       o lugar mais escuro do quarto, encolhendo-se enquanto o assobio e a risada parecem zombar dele.                |\n");
	printaLinha(); noDaMatinta4B(); break;

	case 2:
	printaLinha();
	printf("|                    Um acesso de coragem misturada com desespero toma conta de Bento.                                 |\n");
	printf("|                     Ele corre até a porta e a abre de uma vez, pronto para gritar,                                   |\n");
	printf("|                         mas encontra apenas a noite vazia e o vento uivando.                                         |\n");
	printaLinha(); noDaMatinta4C(); break;

	case 3:
	printaLinha();
	printf("|           Percebendo o erro grave que cometeu, Bento grita para o teto, com a voz embargada de pânico:  	           |\n");
	printf("|  'Me desculpe! Por favor, me desculpe!'. Ele espera que seu arrependimento seja o suficiente para acalmar a fúria.   |\n");
	printaLinha(); noDaMatinta4A(); break;
	}
...
void noDaMatinta3C() {
	...
	printaLinha();
	printf("|                             Quando Bento olhou pela fresta, ele não viu a velha.                                     |\n");
	printf("|             Ele viu a trouxa de fumo sumir da pedra como se uma mão invisível a pegasse  E então                     |\n");
	printf("|      uma sombra densa e escura se formou no chão. A sombra cresceu, tomou a forma de um pássaro enorme,              |\n");
	printf("|            de asas pesadas, que subiu aos céus e desapareceu na escuridão, sem fazer nenhum som.                     |\n");
	printaLinha();
	...
	case 1:
	printaLinha();
	printf("|             Impulsionado por uma curiosidade imprudente, Bento abre a porta e corre para fora,                       |\n");
	printf("|       olhando para o local onde a sombra subiu. Ele não vê nada além das estrelas, mas sente um arrepio,             |\n");
	printf("|                            como se ainda estivesse sendo observado de cima.                                          |\n");
	printaLinha(); noDaMatinta4C(); break;

	case 2:
	printaLinha();
	printf("|             Aquilo foi o suficiente. Bento corre e passa o ferrolho na porta e nas janelas,                          |\n");
	printf("|                                    sentando-se num canto escuro.                                                     |\n");
	printf("|       Ele entende que lidou com algo que não é deste mundo e busca conforto na única proteção que conhece.           |\n");
	printaLinha(); noDaMatinta4A(); break;

	case 3:
	printaLinha();
	printf("|                            Ele permanece na janela, os olhos fixos na escuridão do céu,                              |\n");
	printf("|                         tentando encontrar qualquer sinal do pássaro. A noite parece quieta,                         |\n");
	printf("|            mas o silêncio agora é ameaçador, e o assobio retorna, distante, como um eco na sua mente.                |\n");
	printf("|                                                                                                                      |\n");
	printaLinha(); noDaMatinta4B(); break;
	}
    }
...
void noDaMatinta4A() {
	...
	printaLinha();
	printf("|                       Depois que Bento disso, a noite voltou ao normal.                                              |\n");
	printf("|        O vento parou, o assobio sumiu. Um silêncio profundo e pacífico tomou conta do lugar.                         |\n");
	printf("|               Na manhã seguinte, Bento encontrou, no lugar onde deixou o fumo,                                       |\n");
	printf("|              uma única pena preta, brilhante e perfeita, como um agradecimento.                                      |\n");
	printaLinha();
	...
	case 1:
	printaLinha();
	printf("|                        Bento se aproxima com cuidado e pega a pena preta.                                            |\n");
	printf("|                          Ela é macia e estranhamente quente ao toque.                                                |\n");
	printf("|                 Ele a leva para dentro e a guarda em uma pequena caixa de madeira,                                   |\n");
	printf("|                            como um amuleto ou um troféu silencioso.                                                  |\n");
	printaLinha(); noDaMatinta5A(); break;

	case 2:
	printaLinha();
	printf("|                        Com medo de que a pena pudesse ter algum feitiço,                                             |\n");
	printf("|                                   Bento decide não tocar nela.                                                       |\n");
	printf("|        Ele a deixa ali, como um sinal de que a troca acabou e que ele não quer mais nada daquela entidade            |\n");
	printf("|                                      nem o bem, nem o mal.                                                           |\n");
	printaLinha(); noDaMatinta5B(); break;

	case 3:
	printaLinha();
	printf("|                  Num ato final de desafio, Bento pega a pena, acende um fósforo e a queima.                          |\n");
	printf("|                        A pena se desfaz em uma fumaça escura com um cheiro estranho,                                 |\n");
	printf("|              e ele sente que, com aquele gesto, quebrou o pacto de paz que havia sido oferecido.                     |\n");
	printaLinha(); noDaMatinta5C(); break;
	}
    }
...
void noDaMatinta4B() {
	...
	printaLinha();
	printf("|                               A recusa de Bento trouxe consequências.                                                |\n");
	printf("|                      O assobio não parou mais. Ele entrou na sua cabeça, dia e noite,                                |\n");
	printf("|                            mesmo sob o sol quente, ele ouvia o som agudo.                                            |\n");
	printf("|                 Ele não dormia, não comia direito. Vivia atormentado, olhando para as sombras,                       |\n");
    printf("|                   sempre com a sensação de que aqueles olhos de brasa o observavam de longe.                         |\n");
	...
	case 1:
	printaLinha();
	printf("|                          Incapaz de suportar mais, Bento decide abandonar tudo.                                      |\n");
	printf("|              Ele arruma suas poucas coisas em uma trouxa e deixa para trás a casa onde nasceu,                       |\n");
	printf("|                  na esperança de que a distância possa silenciar o assobio que o persegue.                           |\n");
	printaLinha(); noDaMatinta5C(); break;

	case 2:
	printaLinha();
	printf("|                           Arrependido, ele prepara a melhor oferenda que pode:                                       |\n");
	printf("|                             fumo de rolo, um pouco de cachaça e café fresco.                                         |\n");
	printf("|               Ele deixa tudo do lado de fora à noite, um pedido mudo de perdão pela sua falha inicial.               |\n");
	printaLinha(); noDaMatinta5A(); break;

	case 3:
	printaLinha();
	printf("|                 Desesperado, Bento viaja até uma aldeia vizinha para procurar o velho pajé.                          |\n");
	printf("|   Ele conta sua história, esperando que a sabedoria do ancião possa lhe dar uma solução para quebrar a maldição.     |\n");
	printaLinha(); noDaMatinta5B(); break;
	}
}
...
void noDaMatinta4C() {
	...
	printaLinha();
	printf("|                      A curiosidade de Bento o levou para fora, para a escuridão.                                     |\n");
	printf("|              Ele não encontrou ninguém. Mas a partir daquela noite, ele começou a ver coisas.                        |\n");
	printf("|       Um vulto que passava rápido no canto do olho, a sombra de um pássaro onde não havia pássaro nenhum.            |\n");
	printf("|            Ele sentia que não estava mais sozinho, que algo o acompanhava, sempre à espreita.                        |\n");
	printaLinha();
	...
	case 1:
	printaLinha();
	printf("|           Bento se cansa de ter medo. Na próxima vez que vê o vulto, ele corre em sua direção,                       |\n");
	printf("|    entrando na mata escura, gritando, tentando encurralar a sombra que sempre parece estar um passo à sua frente.    |\n");
	printaLinha(); noDaMatinta5C(); break;

	case 2:
	printaLinha();
	printf("|                Ele entende que a presença quer algo. Sem saber se é a Matinta ou outro espírito,                     |\n");
	printf("|                          ele deixa fumo e café na soleira da porta todas as noites,                                  |\n");
	printf("|                             esperando que o gesto de respeito acalme a criatura.                                     |\n");
	printf("|                                                                                                                      |\n");
	printaLinha(); noDaMatinta5B(); break;

	case 3:
	printaLinha();
	printf("|               Ele decide que não vai enlouquecer. Tenta ignorar as sombras, os vultos.                               |\n");
	printf("|              Continua seu trabalho na roça, sua pescaria, fingindo que nada está errado,                             |\n");
	printf("|                 enquanto a presença ao seu redor parece ficar cada vez mais ousada.                                  |\n");
	printaLinha(); noDaMatinta5A(); break;
    }
}
...
void noDaMatinta5A() {
	...
	printaLinha();
	printf("|                  Bento entendeu que precisava mostrar respeito. Fez um pacto silencioso.                             |\n");
	printf("|       Ele nunca mais foi perturbado pelo assobio. Na verdade, as coisas na sua vida começaram a dar certo,           |\n");
	printf("|     a roça ficou mais farta, a pesca, mais abundante. Ele aprendeu a conviver com o mistério daquela presença.       |\n");
	printaLinha();
...
void noDaMatinta5B() {
	...
	printaLinha();
	printf("|  Bento tentou seguir em frente, seja pedindo ajuda ou simplesmente ignorando os assobios. Mas a Matinta não esquece. |\n");
	printf("|       O tormento diminuiu, mas nunca desapareceu por completo. De vez em quando, numa noite muito silenciosa,        |\n");
	printf("|              ele ainda ouvia o assobio bem longe, como um lembrete de uma dívida que ele nunca pagou.                |\n");
	printf("|                      Ele vivia com uma paz frágil, sempre com medo que ela voltasse.                                 |\n");
	printaLinha();
...
void noDaMatinta5C() {
	...
	printaLinha();
	printf("|      A teimosia de Bento foi maior que seu bom senso. Uma afronta ao espírito, ele cometeu o desrespeito final       |\n");
	printf("|                             O assobio se tornou ensurdecedor e constante.                                            |\n");
	printf("|     Dizem que ele enlouqueceu, falando sozinho e brigando com as sombras, até o dia em que desapareceu na mata,      |\n");
	printf("|                  e tudo que encontraram foi o chapéu dele caído perto de uma gameleira antiga.                       |\n");
	printaLinha();
